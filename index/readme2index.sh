...
# Or:    ./readme2index.sh --input path/to/README.md --app-name packages > index.html
# Or:    README=/path/to/README.md APP_NAME=packages ./readme2index.sh > index.html
...
<head>
  ...
  <title>pirafrank's packages</title>
  <style>
